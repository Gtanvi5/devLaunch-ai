...
import { BrainCircuit, ArrowRight, Clock, SearchX } from "lucide-react";
      ...
      <div className="max-w-5xl mx-auto space-y-8">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
          ...
          <div className="flex flex-col sm:flex-row w-full md:w-auto items-center gap-4">
            {totalReportsCount > 0 && <HistorySearch />}

            <Link href="/dashboard" className="w-full sm:w-auto">
              <Button className="w-full bg-linear-to-r from-violet-600 to-blue-600 hover:from-violet-500 hover:to-blue-500 text-white border-0 transition-all hover:scale-105 shadow-md hover:shadow-lg">
                New Report
              </Button>
            </Link>
          </div>
        ...
        {totalReportsCount === 0 ? (
          <div className="text-center py-24 px-6 bg-white dark:bg-zinc-900/50 rounded-3xl border-2 border-dashed border-zinc-200 dark:border-zinc-800 transition-colors">
            ...
            <p className="text-zinc-500 dark:text-zinc-400 mb-8 max-w-md mx-auto leading-relaxed">
              ...
              boundaries with an adaptive olfactory OS, it&apos;s time to see if
              the market is ready.
            </p>
            <Link href="/dashboard">
          ...
          <div className="text-center py-20 px-6 bg-white dark:bg-zinc-900/50 rounded-3xl border border-zinc-200 dark:border-zinc-800 transition-colors">
            ...
            <p className="text-zinc-500 dark:text-zinc-400 mb-6">
              We couldn&apos;t find any validation reports matching your search.
            </p>
            <Link href="/history">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {userReports.map((report) => (
              <Card
                key={report.id}
                className="hover:shadow-xl dark:hover:shadow-violet-500/10 transition-all duration-300 bg-white dark:bg-zinc-900/50 border-zinc-200 dark:border-zinc-800 flex flex-col justify-between group rounded-2xl"
              >
                <CardHeader>
